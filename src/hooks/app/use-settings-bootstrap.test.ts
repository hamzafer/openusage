...
vi.mock("@/lib/settings", () => ({
  ...
  loadMenubarPinnedPlugins: loadMenubarPinnedPluginsMock,
...
describe("useSettingsBootstrap", () => {
  beforeEach(() => {
    ...
    loadMenubarPinnedPluginsMock.mockReset()
    ...
    loadMenubarPinnedPluginsMock.mockResolvedValue([])
